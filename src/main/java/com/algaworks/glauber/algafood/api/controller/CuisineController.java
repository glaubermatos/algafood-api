...
public class CuisineController {
	...
	@GetMapping
	public Page<CuisineModel> listar(@PageableDefault(size = 2) Pageable pageable) {
		Page<Cuisine> page = cuisineRepository.findAll(pageable);
		
		List<CuisineModel> cuisinesModel = cuisineModelAssembler.toCollectionModel(page.getContent());
		
		var cuisinesModelPage = new PageImpl<>(cuisinesModel, pageable, page.getTotalElements());
